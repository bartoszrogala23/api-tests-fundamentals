...
public class Util {
    ...
    public static final String REGISTER_MESSAGE = "User a registered";

    public static Register parseRegister(String body) {
        var response = PrimerService.postRegister(body, SC_CREATED);

         return gson.fromJson(response.getBody().asString(), Register.class);
    }
}
